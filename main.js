...
const TARGETS = [
  {
    index: 0,
    title: "Web and App Development Workshop",
    subtitle: "Scan the poster to watch",
    youtubeId: "6Jk0zgNmXZ4",
    bullets: ["Web Development", "App Development", "Workshop Details"],
  },
  {
    index: 1,
    title: "TEDx Sanjivani University",
    subtitle: "Scan the poster to watch",
    youtubeId: "Gp-ldFrgK1s",
    bullets: ["Inspiring Ideas", "TED Talks", "University Event"],
  },
  {
    index: 2,
    title: "Smart India Hackathon 2025",
    subtitle: "Scan the poster to watch",
    youtubeId: "o2thRBkKnJc",
    bullets: ["Innovation Challenge", "Problem Solving", "Hackathon"],
  },
  {
    index: 3,
    title: "Ohayo Japan - Japan Festival",
    subtitle: "Scan the poster to watch",
    youtubeId: "KgayxOF4Y7E",
    bullets: ["Japanese Culture", "Festival Celebration", "University Event"],
  },
  {
    index: 4,
  ...
  },
  {
    ...
    subtitle: "Scan the poster to watch",
    youtubeId: "Gp-ldFrgK1s",
    bullets: ["Discovery & Innovation", "Learning Experience", "Annual Event"],
  },
  {
    index: 7,
    title: "Mission Exploit 1st Edition",
    subtitle: "Scan the poster to watch",
    youtubeId: "o2thRBkKnJc",
    bullets: ["Cyber Security", "Hacking Challenge", "First Edition"],
  },
];
