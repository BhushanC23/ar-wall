...
const TARGETS = [
  {
    index: 0,
    title: "Website & Mobile App Development Workshop",
    subtitle: "Workshop conducted at Sanjivani University",
    youtubeId: "0RSlCFG6htQ",
    bullets: ["Website Development", "Mobile App Development", "WebAR Project Showcase"],
  },
  {
    index: 1,
    title: "TEDx Sanjivani University – Seeds of Innovation",
    subtitle: "Inspiring talks and ideas at Sanjivani University",
    youtubeId: "_zgu5BAAfFM",
    bullets: ["Inspiring Ideas", "TED Talks", "Innovation & Growth"],
  },
  {
    index: 2,
    title: "Smart India Hackathon 2025 – Internal Hackathon",
    subtitle: "Innovation & problem-solving at Sanjivani University",
    youtubeId: "quFWEKMLbk8",
    bullets: ["Innovation Challenge", "Teamwork & Problem Solving", "Hackathon Event"],
  },
  {
    index: 3,
  ...
  {
    index: 4,
    title: "Sanjivani Sankalp 2K25 – Induction Program",
    subtitle: "A meaningful beginning for new students",
    youtubeId: "LapShmDf4e0",
    bullets: ["Induction Program", "New Student Welcome", "University Orientation"],
  },
  {
    index: 5,
    title: "Garba @ Sanjivani",
    subtitle: "Celebrating culture, energy, and togetherness",
    youtubeId: "yXpGDPt7P0U",
    bullets: ["Cultural Dance", "Traditional Celebration", "Campus Community"],
  },
  {
    index: 6,
    title: "Eureka! 2025 – Startup Pitching Competition",
    subtitle: "Showcasing innovation and entrepreneurial spirit",
    youtubeId: "o2zQEV4ZwQU",
    bullets: ["Startup Pitching", "Innovation & Entrepreneurship", "Competition Event"],
  },
  {
    index: 7,
    title: "Mission Exploit – Cyber Security Event",
    subtitle: "A technical event showcasing security excellence",
    youtubeId: "8c1lskCvUyg",
    bullets: ["Cyber Security", "Technical Challenge", "First Edition"],
  },
];
